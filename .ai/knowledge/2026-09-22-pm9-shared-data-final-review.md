...
2026-09-22 D1 post-review CI confirmed：Actions 35677887974 @ ae347de9f5fc1922efa7c4af99c0e606e6bde26a 的 Windows x64、macOS Intel、Apple Silicon 全部通过；各平台 21 个既有真实 worker 场景通过，native probe/worker probe workflow job skipped。报告 ci-d1-final-*.json 已保存。物理安装、签名、公证、真实 Google/OAuth 与 D1 专门坏值 worker 仍未验收。
