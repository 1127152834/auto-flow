...
2026-09-23 本机最终eb50e1ef：全后端3483 passed/78 skipped/2 warnings，792.43秒；38定向/11删除契约/6前端/101脚本/Ruff/mypy407/typecheck/lint/构建打包通过，新包完整桌面passed。backend SHA256 cb6b8166723b1c4b103b69e100f1037af9e0b8dcaa48c9920a4e0c2c9f366908。新CI35874897768运行中；后续只有证据/方案修改，不重复触发矩阵。两份复现补丁已去除本机绝对导入路径，基于53d6e986在临时目录git apply --check、实际apply、node --check通过。AD方案补充具体文件和reconciling恢复语义，仍proposed。
