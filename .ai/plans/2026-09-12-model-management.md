...
- 日期：2026-09-12
- 状态：confirmed；实现与baseline合并验收完成
...
- 2026-09-12合并更新（confirmed）：用户已授权合入baseline；冲突解决和回归见 [合并记录](../../docs/migration/model-management-baseline-merge.md)。Alembic唯一head为0003_merge_proxy_models，保留两边既有迁移历史。
