...
test('record-pages mode records required evidence levels and leaves visual review pending',async()=>{
  ...
  for(const id of ['r2-create-normal','r2-create-dirty','r2-create-saving','r2-detail-loading','r2-detail-normal','r2-edit-normal','r2-edit-dirty','r2-detail-404','r2-detail-read-error','r2-detail-200'])assert.match(source,new RegExp(id))
