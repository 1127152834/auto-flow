...
try {
  ...
  await waitFor(page, 'nativePickerResult.cancel', 'operator cancels native open panel', 180000)
  ...
  await waitFor(page, 'nativePickerResult.selection', 'operator selects native workbook', 180000)
  ...
  await waitFor(page, 'nativePickerResult.saveCancel', 'operator cancels native save panel', 180000)
