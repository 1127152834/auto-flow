...
const availability = { automations: 'notImplemented', data: 'available', runs: 'notImplemented', environments: 'notImplemented', statistics: 'notImplemented', sync: 'notImplemented' } as const
...
it('opens a real project context and the six approved tabs without fake controls', async () => {
  ...
  expect(screen.getByRole('heading', {level:2,name:'数据表'})).toBeVisible()
