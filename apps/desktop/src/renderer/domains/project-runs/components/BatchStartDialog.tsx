...
export function BatchStartDialog({ open, formSessionKey, automationName, expectedAutomationRevision, parameters, value, onChange, onOpenChange, onSubmit, checks, resources, submitting = false, recovering = false, errors: serverErrors = {}, errorMessage, onConfigure, recoveryActions, inputPreview, temporaryEnvironmentOverride = { source: 'newFromProfile' } }: BatchStartDialogProps) {
