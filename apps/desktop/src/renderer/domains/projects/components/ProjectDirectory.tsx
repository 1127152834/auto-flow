...
type Props = {
  ...
  /** Cleanup residue the service already reported, keyed by project. */
  cleanupResidue?: Record<string, string[]>
...
export function ProjectDirectory({ mode = 'all', onModeChange, recentItems = [], recentLoading = false, recentError = null, page, conditions, loading, refreshing, disabled, error, onConditionsChange, onRefresh, onCreate, onOpen, onEdit, onLifecycle, cleanupResidue = {}, initialScrollTop = 0, onScrollTopChange }: Props) {
