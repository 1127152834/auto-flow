...
export function TemplateManager({ api }: { api: Pick<FleetApi, 'profiles' | 'standardProfile' | 'saveProfile'> & { archiveProfile: (id: string, body: { requestId: string; expectedRevision: number }) => Promise<Profile> } }) {
