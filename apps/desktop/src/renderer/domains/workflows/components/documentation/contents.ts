// Source: WebRPA@5ccb900e, components/workflow/documentation/contents.ts; see SOURCE.md for license and adaptation boundaries.
/**
 * 教学文档懒加载索引
 *
...
for (const [path, loader] of Object.entries(loaders)) {
  ...
  if (docId) docIdToLoader.set(docId, loader)
}
...
/** 异步获取某文档的 markdown 内容；命中缓存则直接返回。 */
