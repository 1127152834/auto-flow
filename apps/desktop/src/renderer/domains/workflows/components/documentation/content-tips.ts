// Source: WebRPA@5ccb900e, components/workflow/documentation/content-tips.ts; see SOURCE.md for license and adaptation boundaries.
export const tipsTricksContent = `# 技巧与窍门

> 当前 Studio 教学范围为保留节点及前端配置交互。Mock 用于交互演示，不执行真实网页、模型或系统操作；文中的执行行为需正式后端支持。

本章汇总各种实用技巧，帮助你更高效地使用AutoFlow。
