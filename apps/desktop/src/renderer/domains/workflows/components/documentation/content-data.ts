// Source: WebRPA@5ccb900e, components/workflow/documentation/content-data.ts; see SOURCE.md for license and adaptation boundaries.
...
这里保留的是采集结果导出格式选项，不包含工作簿、单元格或公式自动化节点。
...
**提示**：使用保存路径旁的目录选择入口；可用目录由宿主与服务提供。
...
AutoFlow 提供了丰富的字符串处理模块，帮助你灵活处理文本数据。
