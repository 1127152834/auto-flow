...
// Source: WebRPA@5ccb900e, components/workflow/ModuleSidebar.tsx; see SOURCE.md for license and adaptation boundaries.
import { ScrollArea } from './controls/scroll-area'
import { Input } from './controls/input'
import { moduleTypeLabels, useWorkflowStore } from '../editor-store'
...
function ModuleSidebarRaw() {
  ...
  const filteredCategories = useMemo(() => {
    ...
    const categories = sortedCategoriesCache
