...
export function RunToolbar({ profiles, profileId, onProfileChange, active, busy, uncertain, disabled, profilesLoading, profilesError, onStart, onStop, onRefresh, canRetryStart, onRetryStart }: Props) {
  return <div className="flex shrink-0 flex-wrap items-center gap-3 border-b border-line bg-surface px-5 py-2.5" aria-label="流程运行控制">
    <label htmlFor="run-profile" className="text-xs font-medium text-muted">浏览器配置</label>
