// Source: WebRPA@5ccb900e, components/workflow/AICodeAssistant.tsx; see SOURCE.md for license and adaptation boundaries.
...
代码应该可以直接运行，无需任何修改。`
  ...
  const generateCode = async () => {
    ...
    try {
      ...
      const response = await studioFetch(globalConfig.ai.apiUrl, {
        method: 'POST',
        headers: headers,
