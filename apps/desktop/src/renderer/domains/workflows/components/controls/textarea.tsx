// Source: WebRPA@5ccb900e, components/ui/textarea.tsx; see SOURCE.md for license and adaptation boundaries.
  ...
  ({ className, ...props }, ref) => {
    return (
      <textarea
        ref={ref}
        className={cn(
          'flex min-h-[76px] w-full rounded-control px-2.5 py-2 text-[13px] ' +
