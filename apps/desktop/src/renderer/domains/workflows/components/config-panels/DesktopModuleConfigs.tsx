// Source: WebRPA@5ccb900e, components/workflow/config-panels/DesktopModuleConfigs.tsx; see SOURCE.md for license and adaptation boundaries.
...
import { WindowTitleInput } from '../controls/window-title-input'
