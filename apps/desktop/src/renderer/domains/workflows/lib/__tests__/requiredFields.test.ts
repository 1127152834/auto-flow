// Source: WebRPA@5ccb900e, lib/__tests__/requiredFields.test.ts; see SOURCE.md for license and adaptation boundaries.
import { describe, it, expect } from 'vitest'
import { getMissingRequired, getMissingRequiredLabels } from '../requiredFields'
