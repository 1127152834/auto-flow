// Source: WebRPA@5ccb900e, lib/__tests__/fieldLabels.test.ts; see SOURCE.md for license and adaptation boundaries.
import { describe, it, expect } from 'vitest'
import { getFieldLabel, COMMON_FIELD_LABELS } from '../fieldLabels'
