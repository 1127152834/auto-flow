// Source: WebRPA@5ccb900e, lib/__tests__/pinyin.test.ts; see SOURCE.md for license and adaptation boundaries.
import { describe, it, expect } from 'vitest'
import { getPinyin, getPinyinInitials, pinyinMatch } from '../pinyin'
