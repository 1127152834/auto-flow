// Source: WebRPA@5ccb900e, lib/__tests__/i18n.test.ts; see SOURCE.md for license and adaptation boundaries.
import { describe, it, expect } from 'vitest'
// 复用既有审计脚本的解析逻辑（其 import.meta 守卫保证 import 时不执行 main）
// @ts-expect-error mjs 无类型声明
import { findDuplicateUiDictKeys, findUntranslatedChinese } from '../../tests/audits/audit-i18n.mjs'
