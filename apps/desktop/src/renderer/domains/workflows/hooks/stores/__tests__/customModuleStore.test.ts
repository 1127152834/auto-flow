// Source: WebRPA@5ccb900e, store/__tests__/customModuleStore.test.ts; see SOURCE.md for license and adaptation boundaries.
...
import { useCustomModuleStore } from '../customModuleStore'
