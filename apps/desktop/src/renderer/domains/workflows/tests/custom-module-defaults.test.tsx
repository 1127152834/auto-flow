...
it('does not offer the removed database category for custom modules', () => {
  render(<CreateCustomModuleDialog open onClose={vi.fn()} />)
  expect(screen.queryByRole('option', { name: '数据库' })).toBeNull()
})
