...
export function RecordDetailPage({ title, fieldsView, statusForm, updatedAt, loading, error, readonly, disabled, onEdit, onDelete, onRetry }: RecordDetailPageProps) {
