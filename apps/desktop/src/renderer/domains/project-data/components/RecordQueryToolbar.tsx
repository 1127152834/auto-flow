...
export type RecordQueryToolbarProps = {
  ...
  disabled?: boolean; readonly?: boolean; exportDisabled?: boolean; queryError?: string; totalCount?: number; selectionCount: number; onClearSelection(): void; onCreate(): void; onBatchStatus(): void; onExport(): void; onReimport?(): void
...
export function RecordQueryToolbar({ fields, statuses, query, visibleFieldIds, quickSearch, disabled=false, readonly=false, exportDisabled=false, queryError, totalCount, selectionCount, onClearSelection, onCreate, onBatchStatus, onExport, onReimport, onApplyQuery, onApplyColumns, onApplySearch, resetKey }: RecordQueryToolbarProps) {
