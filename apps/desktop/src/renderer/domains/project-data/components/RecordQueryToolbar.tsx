...
function Panel({ open, onOpenChange, kind, trigger, label, icon, applied, disabled, children }: { open: boolean; onOpenChange(open:boolean):void; kind:Exclude<QueryPanel,null>; trigger:string; label:string; icon:ReactNode; applied:boolean; disabled?:boolean; children:ReactNode }) {
