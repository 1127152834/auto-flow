...
# backend/app/executors/math_list_ops.py.
import asyncio
import math
...
class ListSumExecutor(ModuleExecutor):
    ...
    async def execute(
        ...
        try:
            ...
            for index, item in enumerate(list_data):
                ...
                if isinstance(item, (int, float)):
                    ...
                    try:
                        ...
                        return ModuleResult(
                            success=False, error=f"列表包含非数字元素: {item}"
                        )
            ...
            return ModuleResult(
                success=True, message=f"列表求和: {result}", data=result
            )

        except Exception as e:
            return ModuleResult(success=False, error=f"求和失败: {e!s}")
...
class ListAverageExecutor(ModuleExecutor):
    ...
    async def execute(
        ...
        try:
            ...
            return ModuleResult(
                success=True, message=f"列表平均值: {result}", data=result
            )

        except Exception as e:
            return ModuleResult(success=False, error=f"求平均值失败: {e!s}")
...
class ListMaxExecutor(ModuleExecutor):
    ...
    async def execute(
        ...
        try:
            ...
            return ModuleResult(
                success=True, message=f"列表最大值: {result}", data=result
            )

        except Exception as e:
            return ModuleResult(success=False, error=f"求最大值失败: {e!s}")
...
class ListMinExecutor(ModuleExecutor):
    ...
    async def execute(
        ...
        try:
            ...
            return ModuleResult(
                success=True, message=f"列表最小值: {result}", data=result
            )

        except Exception as e:
            return ModuleResult(success=False, error=f"求最小值失败: {e!s}")
...
class ListSortExecutor(ModuleExecutor):
    ...
    async def execute(
        ...
        try:
            ...
            return ModuleResult(
                success=True, message=f"列表已{order_text}排序", data=sorted_list
            )
...
class ListUniqueExecutor(ModuleExecutor):
    ...
    async def execute(
        ...
        try:
            ...
            return ModuleResult(success=False, error=f"去重失败: {e!s}")
...
class ListSliceExecutor(ModuleExecutor):
    ...
    async def execute(
        ...
        try:
            ...
            return ModuleResult(success=False, error=f"索引值无效: {e!s}")
        except Exception as e:
            return ModuleResult(success=False, error=f"截取失败: {e!s}")
...
class MathRoundExecutor(ModuleExecutor):
    ...
    async def execute(
        ...
        try:
            ...
            return ModuleResult(
                success=True, message=f"四舍五入: {num} → {result}", data=result
            )

        except (ValueError, TypeError):
            return ModuleResult(success=False, error=f"无效的数字: {number_value}")
        except Exception as e:
            return ModuleResult(success=False, error=f"四舍五入失败: {e!s}")
...
class MathBaseConvertExecutor(ModuleExecutor):
    ...
    async def execute(
        ...
        try:
            ...
            return ModuleResult(success=False, error=f"无效的数字或进制: {e!s}")
        except Exception as e:
            return ModuleResult(success=False, error=f"进制转换失败: {e!s}")
...
class MathFloorExecutor(ModuleExecutor):
    ...
    async def execute(
        ...
        try:
            ...
            return ModuleResult(
                success=True, message=f"向下取整: {num} → {result}", data=result
            )

        except (ValueError, TypeError):
            return ModuleResult(success=False, error=f"无效的数字: {number_value}")
        except Exception as e:
            return ModuleResult(success=False, error=f"取整失败: {e!s}")
...
class MathModuloExecutor(ModuleExecutor):
    ...
    async def execute(
        ...
        try:
            ...
            return ModuleResult(
                success=True, message=f"求余: {num1} % {num2} = {result}", data=result
            )

        except (ValueError, TypeError):
            return ModuleResult(success=False, error="无效的数字")
        except Exception as e:
            return ModuleResult(success=False, error=f"求余失败: {e!s}")
...
class MathAbsExecutor(ModuleExecutor):
    ...
    async def execute(
        ...
        try:
            ...
            return ModuleResult(
                success=True, message=f"绝对值: |{num}| = {result}", data=result
            )

        except (ValueError, TypeError):
            return ModuleResult(success=False, error=f"无效的数字: {number_value}")
        except Exception as e:
            return ModuleResult(success=False, error=f"求绝对值失败: {e!s}")
...
class MathSqrtExecutor(ModuleExecutor):
    ...
    async def execute(
        ...
        try:
            ...
            return ModuleResult(success=False, error=f"开次方失败: {e!s}")
...
class MathPowerExecutor(ModuleExecutor):
    ...
    async def execute(
        ...
        try:
            ...
            return ModuleResult(success=False, error=f"求次方失败: {e!s}")
