            ...
            with open(os.devnull, "w", encoding="utf-8") as sink, redirect_stdout(sink), redirect_stderr(sink):  # noqa: ASYNC230
                ...
                executor = ProjectGraphExecutor(
                    ...
                    lambda node_id, visit, module_type: ProjectArtifactWriter(
                        ...
                        node_id, visit,
                        {"screenshot": "screenshot", "download_file": "file", "save_image": "image", "list_export": "file", "export_log": "file", "table_export": "file", "extract_table_data": "file", "allure_generate_report": "file"}[module_type],
                        emit,
                    ),
