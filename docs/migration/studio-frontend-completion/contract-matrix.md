...
| event:hotkey:run | apps/desktop/src/renderer/domains/workflows/components/Toolbar.tsx:694 | apps/desktop/src/renderer/domains/workflows/events.ts:678 | 字段/关联身份/恢复语义仍需核对 |
...
| event:hotkey:stop | apps/desktop/src/renderer/domains/workflows/components/Toolbar.tsx:695 | apps/desktop/src/renderer/domains/workflows/events.ts:685 | 字段/关联身份/恢复语义仍需核对 |
