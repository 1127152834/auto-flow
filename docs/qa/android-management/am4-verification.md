...
当前增量基线：`a47bbb9d`，后端 `346 passed, 2 warnings`；[归档安全与属性](2026-09-23-archive-verification.md)记录真实新实例启动、UID/GID/mode 及链接保真。下表早期证据保留，整任务仍需重审；未执行的失败演练不作为外部条件 blocked。
