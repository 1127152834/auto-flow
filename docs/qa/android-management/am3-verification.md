...
| T15 应用管理 | `partial` | APK 校验、保护包、控制/确认及未知结果自动化通过；真实安装/版本/启动/停止/清数据/卸载和[跨重建回执核实](2026-09-24-final-branch-review.md)已验。[真实覆盖安装中断](2026-09-24-app-interruption.md)已验ADB断线/HTTP进程树SIGKILL与重启隔离；桌面破坏性确认同链仍未验。 |
