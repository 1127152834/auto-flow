...
审计基线：`432d1cdc`；当前聚焦后端 `175 passed, 1 warning`、前端 Android `13 files, 47 passed`；真实双实例基础证据来自 [总体验收记录](2026-09-22-validation.md)。
...
13 files, 47 passed（含旧设备列表轮询和 stale/unknown 打开保护回归）
```
